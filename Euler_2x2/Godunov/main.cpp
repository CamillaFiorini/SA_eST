...
int main()
{
	double xa(0), xb(1), dx(1e-5), T(0.04), t(0), dt;
	mesh M (xa, xb, dx);
	int N = M.get_N();
...
*/
	ofstream file_u ("results/shock_raref/dx1e-5/u.dat");
	ofstream file_tau ("results/shock_raref/dx1e-5/tau.dat");
	ofstream file_s_u ("results/shock_raref/dx1e-5/s_u.dat");
	ofstream file_s_tau ("results/shock_raref/dx1e-5/s_tau.dat");
	ofstream file_t ("results/shock_raref/dx1e-5/t.dat");
