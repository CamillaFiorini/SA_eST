...
int main()
{
	...
	normal_distribution<double> distribution_tauL(tauL,sqrt(tauL*0.0001));
	normal_distribution<double> distribution_tauR(tauR,sqrt(tauR*0.0001));
	normal_distribution<double> distribution_m(m,sqrt(m*0.0001));
	normal_distribution<double> distribution_L(L,sqrt(L*0.0001));
	normal_distribution<double> distribution_xc(x_c,sqrt(x_c*0.0001));
